...
function nmm_add_wishlist_button() {
    ...
    echo '<button type="button" class="nmm-wishlist-btn nmm-wishlist-btn-icon-only" data-product-id="' . esc_attr( $product_id ) . '" title="' . esc_attr__( 'Add to Wishlist', 'nalli-megamenu' ) . '">
        <svg class="nmm-heart-icon" viewBox="0 0 24 24" width="20" height="20" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
